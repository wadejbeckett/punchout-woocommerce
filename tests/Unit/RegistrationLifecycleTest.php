...
final class RegistrationLifecycleTest extends TestCase {
	public function test_approval_requires_complete_identity_and_valid_entitlements(): void {
		...
		foreach ( [ 'to_domain' => '', 'to_identity' => str_repeat( 'x', 191 ), 'mode' => 'invalid', 'return_encoding' => 'invalid', 'deployment_mode' => 'invalid', 'cxml_version' => 'invalid', 'secret_current' => 'unexpected', 'secret_previous' => 'unexpected' ] as $key => $value ) {
