...
A visit never creates a WordPress user, whatever route asks: core's user insert is refused inside a visit and the refusal is audited as `visit_user_create_refused`.
